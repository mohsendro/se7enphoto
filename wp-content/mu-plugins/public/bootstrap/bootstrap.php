...
if( ! class_exists( 'Bootstrap' ) ) {
	...
	class Bootstrap {
		...
		public function wpplus_enqueuing_bootstrap_styles() {
			...
			wp_enqueue_style( 'bootstrap-reboot.min', plugin_dir_url(__FILE__) . 'css/bootstrap-reboot.min.css', false, '5.3.0' );
			wp_enqueue_style( 'bootstrap.rtl.min', plugin_dir_url(__FILE__) . 'css/bootstrap.rtl.min.css', false, '5.3.0' );
		...
		public function wpplus_enqueuing_bootstrap_scripts() {
			...
			wp_enqueue_script( 'bootstrap.bundle.min', plugin_dir_url(__FILE__) . 'js/bootstrap.bundle.min.js', false, '5.3.0', true );
