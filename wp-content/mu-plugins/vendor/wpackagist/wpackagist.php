...
include plugin_dir_path(__FILE__) . 'vendor/plugins/image-sizes-panel/image-sizes-panel.php';
include plugin_dir_path(__FILE__) . 'vendor/plugins/ultimate-watermark/ultimate-watermark.php';
include plugin_dir_path(__FILE__) . 'vendor/plugins/nirweb-support/nirweb-support.php';
