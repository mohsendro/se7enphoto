...
function shareholder_list_table_init() {
      ...
      echo "<div class='wrap'>";
            ...
            //echo "<form method='get'>";
                  ...
                  //$ShareholderTable->search_box('جستجو', 'search_id');
                  // Display table
                  // if( isset($_GET['shareholder_id']) ) {
                        $ShareholderTable->display();
                  // } else {
...
// Extending class
class Shareholder_List_Table extends WP_List_Table {
      ...
      function column_default($item, $column_name) {
            ...
            switch ($column_name) {
                  ...
                  case 'order_date':
                        return parsidate("Y-m-d h:i:s", $item->date_created, "per") . ' | ' . $item->date_created;
