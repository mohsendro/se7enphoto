...
function wp_kama_woocommerce_admin_order_totals_after_total_action( $order_id ){
...
add_action( 'woocommerce_admin_order_totals_after_total', 'wp_kama_woocommerce_admin_order_totals_after_total_action' );