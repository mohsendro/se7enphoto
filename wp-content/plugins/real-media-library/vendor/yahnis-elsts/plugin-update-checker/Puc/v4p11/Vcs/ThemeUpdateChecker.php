...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_Vcs_ThemeUpdateChecker', \false)) {
    class Puc_v4p11_Vcs_ThemeUpdateChecker extends \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Theme_UpdateChecker implements \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Vcs_BaseChecker
    {
        /**
        ...
        public function requestUpdate()
        {
            ...
            $update = new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Theme_Update();
            ...
            $update->version = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Utils::findNotEmpty(array($remoteHeader['Version'], \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Utils::get($updateSource, 'version')));
            //The details URL defaults to the Theme URI header or the repository URL.
            $update->details_url = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Utils::findNotEmpty(array($remoteHeader['ThemeURI'], $this->package->getHeaderValue('ThemeURI'), $this->metadataUrl));
