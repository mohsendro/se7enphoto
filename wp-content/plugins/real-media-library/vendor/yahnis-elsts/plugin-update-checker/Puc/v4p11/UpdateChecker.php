...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_UpdateChecker', \false)) {
    abstract class Puc_v4p11_UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '')
        {
            ...
            $this->upgraderStatus = new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_UpgraderStatus();
            $this->updateState = new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_StateStore($this->optionName);
            if (\did_action('init')) {
                $this->loadTextDomain();
            } else {
         ...
         */
        protected function fixSupportedWordpressVersion(\MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Metadata $update = null)
        {
        ...
        {
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_DebugBar_Extension($this);
        }
        /**
