...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_Vcs_GitHubApi', \false)) {
    class Puc_v4p11_Vcs_GitHubApi extends \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Vcs_Api
    {
        /**
        ...
        public function getLatestRelease()
        {
            ...
            if (!empty($release->body)) {
                ...
                $reference->changelog = \MatthiasWeb\RealMediaLibrary\Vendor\Parsedown::instance()->text($release->body);
            }
            return $reference;
        }
        /**
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $tag->zipball_url, 'apiResponse' => $tag));
        }
        /**
