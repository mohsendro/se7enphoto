...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_Theme_UpdateChecker', \false)) {
    class Puc_v4p11_Theme_UpdateChecker extends \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_UpdateChecker
    {
        ...
        {
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Scheduler($this, $checkPeriod, array('load-themes.php'));
        }
        /**
        ...
        {
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_DebugBar_Extension($this, 'Puc_v4p11_DebugBar_ThemePanel');
        }
        /**
        ...
        {
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Theme_Package($this->stylesheet, $this);
        }
    }
}
