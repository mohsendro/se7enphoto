...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_StateStore', \false)) {
    class Puc_v4p11_StateStore
    {
         ...
         * @return $this
         */
        public function setUpdate(\MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Update $update = null)
        {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        ...
        public function save()
        {
            ...
            if (isset($this->update)) {
                ...
                if (\MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load()
        {
            ...
            $this->lastCheck = \intval(\MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Utils::get($state, 'checkedVersion', '');
            $this->update = null;
