...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_Vcs_PluginUpdateChecker')) {
    class Puc_v4p11_Vcs_PluginUpdateChecker extends \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Plugin_UpdateChecker implements \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Vcs_BaseChecker
    {
        /**
        ...
        public function requestInfo($unusedParameter = null)
        {
            ...
            $info = new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Plugin_Info();
