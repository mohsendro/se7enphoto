...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_Plugin_Package', \false)) {
    class Puc_v4p11_Plugin_Package extends \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_InstalledPackage
    {
        /**
        ...
        public function isMuPlugin()
        {
            ...
            if ($cachedResult === null) {
                ...
                if ($muPluginDir === \false || $pluginPath === \false) {
                    ...
                    $pluginPath = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Factory::normalizePath($this->pluginAbsolutePath);
                }
