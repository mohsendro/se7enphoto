...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_Plugin_Update', \false)) {
     ...
     * @access public
     */
    class Puc_v4p11_Plugin_Update extends \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Update
    {
        public $id = 0;
        public $homepage;
        ...
        public static function fromJson($json)
        {
            ...
            $pluginInfo = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Plugin_Info::fromJson($json);
            if ($pluginInfo !== null) {
