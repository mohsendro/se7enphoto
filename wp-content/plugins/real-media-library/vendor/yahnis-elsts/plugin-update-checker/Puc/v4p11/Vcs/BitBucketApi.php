...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_Vcs_BitBucketApi', \false)) {
    class Puc_v4p11_Vcs_BitBucketApi extends \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Vcs_Api
    {
        /**
        ...
        public function getBranch($branchName)
        {
            ...
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $ref, 'updated' => $branch->target->date, 'downloadUrl' => $this->getDownloadUrl($branch->name)));
        }
        /**
         * Get a specific tag.
         *
        ...
        public function getTag($tagName)
        {
            ...
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'updated' => $tag->target->date, 'downloadUrl' => $this->getDownloadUrl($tag->name)));
        }
        /**
        ...
        {
            $url = \ltrim($url, '/');
            $isSrcResource = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Utils::startsWith($url, 'src/');
        ...
        public function setAuthentication($credentials)
        {
            ...
            if (!empty($credentials) && !empty($credentials['consumer_key'])) {
                $this->oauth = new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_OAuthSignature($credentials['consumer_key'], $credentials['consumer_secret']);
            } else {
                $this->oauth = null;
            }
        }
