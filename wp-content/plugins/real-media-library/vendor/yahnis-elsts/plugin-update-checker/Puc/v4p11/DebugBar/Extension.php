...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_DebugBar_Extension', \false)) {
    class Puc_v4p11_DebugBar_Extension
    {
        ...
        private function getLibraryUrl($filePath)
        {
            ...
            $absolutePath = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Factory::normalizePath($absolutePath);
            $pluginDir = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Factory::normalizePath(\WP_PLUGIN_DIR);
            $muPluginDir = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Factory::normalizePath(\WPMU_PLUGIN_DIR);
            $themeDir = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Factory::normalizePath(\get_theme_root());
