...
if (!\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Puc_v4p11_Plugin_UpdateChecker', \false)) {
     ...
     * @access public
     */
    class Puc_v4p11_Plugin_UpdateChecker extends \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            $this->extraUi = new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Plugin_Ui($this);
        }
        /**
        ...
        {
            $scheduler = new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Scheduler($this, $checkPeriod, array('load-plugins.php'));
        ...
        public function requestUpdate()
        {
            ...
            $update = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Plugin_Update::fromPluginInfo($pluginInfo);
        ...
        {
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_DebugBar_PluginExtension($this);
        }
        /**
        ...
        {
            return new \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4p11_Plugin_Package($this->pluginAbsolutePath, $this);
        }
        /**
