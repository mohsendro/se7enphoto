...
namespace DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\WpdbBatch;

/**
 * Batch update implementation.
 */
class Update extends \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\WpdbBatch\AbstractBatch {
    /**
