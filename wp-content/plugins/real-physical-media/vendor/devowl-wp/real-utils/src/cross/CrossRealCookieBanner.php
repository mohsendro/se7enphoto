 ...
 */
class CrossRealCookieBanner extends \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\AbstractCrossSelling {
    ...
    public function skip() {
        ...
        $handler = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()->getCrossSellingHandler();
    ...
    public function hasGdprPluginInstalled($plugins) {
        foreach ($plugins as $slug) {
            $file = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()
