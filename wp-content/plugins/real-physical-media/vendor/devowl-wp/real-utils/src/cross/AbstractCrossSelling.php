...
namespace DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross;

use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\UtilsProvider;
use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core;
use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler;
...
abstract class AbstractCrossSelling {
    ...
    public function getAssetsUrl($path = '') {
        return \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()->getBaseAssetsUrl(
    ...
    public function actionCounter($action, $increment = \false) {
        $optionName =
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_CROSS_COUNTER .
            '.' .
            $this->getSlug() .
            '.' .
            $action;
        $cnt = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::get(
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_INITIATOR_CROSS,
            $optionName,
            0
        );
        if ($increment) {
            $cnt++;
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::set(
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_INITIATOR_CROSS,
                $optionName,
                $cnt
            );
    ...
    public function forceHide($action, $force = \false) {
        $skip = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::get(
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_INITIATOR_CROSS,
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_CROSS_SKIP,
            []
        );
        if ($force) {
    ...
    public function dismiss($action, $force) {
        ...
        $ts = \strtotime(
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()
        ...
        if (
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::set(
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_INITIATOR_CROSS,
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_NEXT_CROSS_SELLING,
                $ts
            )
        ) {
            return $ts;
