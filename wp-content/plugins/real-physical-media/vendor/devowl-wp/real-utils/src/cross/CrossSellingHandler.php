...
class CrossSellingHandler {
    ...
    const ALL_VERSIONS = [
        ...
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary::FILE_PRO,
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia::FILE_PRO,
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary::FILE_PRO,
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner::FILE_PRO,
        // Lite versions
        'real-thumbnail-generator-lite/index.php',
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary::FILE_LITE,
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary::FILE_LITE,
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner::FILE_LITE
    ];
    const PRO_VERSIONS = [
        'real-thumbnail-generator/index.php',
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary::FILE_PRO,
    ...
    public function getAvailable() {
        ...
        $result = [];
        foreach (
            \array_values(\DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()->getCrossSellings())
            as $product
        ) {
            if (!$product->skip()) {
    ...
    public static function instance() {
        return new \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossSellingHandler();
    }
}
