...
use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossSellingHandler;
use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary;
use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary;
use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner;
use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia;
use DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\view\Options;
...
class Core {
    ...
    private function __construct() {
        ...
        $this->ratingHandler = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\RatingHandler::instance($this);
        $this->crossSellingHandler = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossSellingHandler::instance(
            $this
        );
        $this->assets = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Assets::instance();
        $options = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\view\Options::instance();
        add_action('rest_api_init', [
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Service::instance(),
            'rest_api_init'
        ]);
        ...
        $this->crossSelling[
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner::SLUG
        ] = new \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner();
        $this->crossSelling[
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary::SLUG
        ] = new \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary();
        $this->crossSelling[
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary::SLUG
        ] = new \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary();
        $this->crossSelling[
            \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia::SLUG
        ] = new \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia();
    ...
    public static function getInstance() {
        return !isset(self::$me)
            ? (self::$me = new \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core())
            : self::$me;
    }
}
