...
use DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\Base;
use DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\Assets;
...
abstract class AbstractInitiator {
    ...
    public function start() {
        \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()->addInitiator($this);
        $this->welcomePage = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\WelcomePage::instance($this);
