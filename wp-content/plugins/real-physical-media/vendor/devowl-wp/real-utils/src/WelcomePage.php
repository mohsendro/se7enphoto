...
class WelcomePage {
    ...
    public function activated_plugin($plugin) {
        ...
        if (!$fromBulkAction && !$isWpCli && $plugin === plugin_basename($this->getInitiator()->getPluginFile())) {
            $alreadyRedirected = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::get(
                $this->getInitiator(),
                \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\TransientHandler::TRANSIENT_REDIRECT_AFTER_ACTIVATE,
                \false
            );
    ...
    <div class="about-wrap-content">
        ...
        $data = [
            ...
            '%subtitle' => \str_replace(
                ...
                \sprintf(
                    '<br /><cite>',
                    \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()->getBaseAssetsUrl(
                        'devowl.io-logo.svg'
                    )
                ),
        ...
        return is_admin() &&
            ...
            $_GET['page'] ===
                $this->getInitiator()->getPluginSlug() .
                    \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\WelcomePage::PAGE_SUFFIX;
    }
    /**
     * Create instance.
     *
    ...
    public static function instance($initiator) {
        return new \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\WelcomePage($initiator);
    }
}
