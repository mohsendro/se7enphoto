...
class Assets {
    ...
    public function overrideLocalizeScript($context) {
        $ratingHandler = \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()->getRatingHandler();
        ...
        return [
            ...
            'cross' => \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Core::getInstance()
    ...
    public static function instance() {
        return new \DevOwl\RealPhysicalMedia\Vendor\DevOwl\RealUtils\Assets();
    }
}
