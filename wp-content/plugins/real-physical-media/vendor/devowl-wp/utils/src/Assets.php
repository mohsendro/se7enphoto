...
trait Assets {
    ...
    public function localizeScript($context) {
        ...
        return [
            'slug' => $this->getPluginConstant(
                \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_SLUG
            ),
            ...
            'restUrl' => $this->getAsciiUrl(\DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\Service::getUrl($this)),
            'restNamespace' => \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\Service::getNamespace($this),
    ...
    public function getChunkTranslationMap() {
        $path =
            $this->getPluginConstant(
                \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_INC
