...
class Service {
    ...
    public function rest_api_init() {
        $namespace = \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\Service::getNamespace($this->getCore());
    ...
    public static function getUrl($instance, $namespace = null, $endpoint = '') {
        $path =
            ($namespace === null
                ? \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\Service::getNamespace($instance)
                : $namespace) .
            '/' .
            $endpoint;
    ...
    public static function instance($core) {
        return new \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\Service($core);
    }
}
