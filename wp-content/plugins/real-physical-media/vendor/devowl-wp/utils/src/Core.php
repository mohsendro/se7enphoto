...
namespace DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils;
...
trait Core {
    ...
    protected function construct() {
        ...
        $pluginFile = $this->getPluginConstant(
            \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_FILE
        );
        // Register immediate actions and filters
        $this->activator = $this->getPluginClassInstance(
            \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CLASS_ACTIVATOR
        );
        $this->assets = $this->getPluginClassInstance(
            \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CLASS_ASSETS
        );
        $this->service = \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\Service::instance($this);
        ...
        $this->getPluginClassInstance(
            \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CLASS_LOCALIZATION
        )->hooks();
        \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PackageLocalization::instance(
            $this->getPluginConstant(
                \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_ROOT_SLUG
            ),
            \dirname(__DIR__)
        )->hooks();
    ...
    public function i18n() {
        load_plugin_textdomain(
            $this->getPluginConstant(
                \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_TEXT_DOMAIN
            ),
            \false,
            \dirname(
                plugin_basename(
    ...
    public function updateDbCheck() {
        $installed = get_option(
            $this->getPluginConstant(
                \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_OPT_PREFIX
            ) . '_db_version'
        );
        if (
            $installed !==
            $this->getPluginConstant(
                \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_VERSION
            )
        ) {
    ...
    public function getInternalPackages() {
        ...
        $globPath = path_join(
            $this->getPluginConstant(
                \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_PATH
            ),
            'vendor/' .
                $this->getPluginConstant(
                    \DevOwl\RealPhysicalMedia\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_ROOT_SLUG
